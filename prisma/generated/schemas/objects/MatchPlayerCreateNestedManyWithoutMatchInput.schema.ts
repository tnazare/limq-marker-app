...
const Schema: z.ZodType<Prisma.MatchPlayerCreateNestedManyWithoutMatchInput> = z
  .object({
    create: z
      .union([
...
export const MatchPlayerCreateNestedManyWithoutMatchInputObjectSchema = Schema;
