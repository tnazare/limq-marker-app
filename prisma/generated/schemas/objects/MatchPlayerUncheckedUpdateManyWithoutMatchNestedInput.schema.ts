...
const Schema: z.ZodType<Prisma.MatchPlayerUncheckedUpdateManyWithoutMatchNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MatchPlayerUncheckedUpdateManyWithoutMatchNestedInputObjectSchema =
  Schema;
